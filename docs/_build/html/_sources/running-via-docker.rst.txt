...
without affecting the host machine or other containers\ [#f4]_.
...
are to images what objects are to classes in the OO paradigm)\ [#f5]_. 
...
Image definitions can be defined by users (e.g. ``Dockerfiles``); there are also standard images publicly available on ``dockerHub``\ [#f6]_
...
.. [#f4] Containers can still interact with each other and the host machine through mounted directories/files or exposed ports.
.. [#f5] https://stackoverflow.com/questions/23735149/what-is-the-difference-between-a-docker-image-and-a-container#:~:text=An%20instance%20of%20an%20image,of%20layers%20as%20you%20describe.&text=You%20can%20see%20all%20your,an%20image%20is%20a%20container
.. [#f6] https://hub.docker.com/
